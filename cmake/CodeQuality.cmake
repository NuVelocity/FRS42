...
if(NVE_CLANG_TIDY)
    ...
    if(CLANG_TIDY_EXE)
        ...
        if(RUN_CLANG_TIDY_EXE)
            ...
            add_custom_target(frs42-clang-tidy-report
            ...
            # Target to auto-fix
            add_custom_target(frs42-clang-tidy-fix
                COMMAND ${RUN_CLANG_TIDY_EXE}
                -p ${CMAKE_BINARY_DIR}
...
if(NVE_CLANG_FORMAT)
    ...
    if(CLANG_FORMAT_EXE)
        ...
        add_custom_target(frs42-clang-format-check
        ...
        add_custom_target(frs42-clang-format-fix
            COMMAND ${CLANG_FORMAT_EXE}
            -i
            ${ALL_SOURCE_FILES}
            WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}
